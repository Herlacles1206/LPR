...
extern void print_easypr();
extern void test_chars_recognise();
extern int test_plate_locate(const char *type, const char *img_path);
extern void plate(const char *img_path);
...
int main(int argc, char **argv)
{
	...
	if ((0 == strcmp(argv[1], "easypr"))&&(0 == strcmp(argv[2], "plate"))){
	
		plate(argv[3]);
	}
	else if (0 == strcmp(argv[1], "easypr")){
		
		test_plate_locate(argv[2], argv[3]);
	}
	else if ((0 == strcmp(argv[1], "easypr"))&&(0 == strcmp(argv[2], "recognise"))){
